        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ParkingLots_Adresses_AdressId",
                        column: x => x.AdressId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    AiAnalysis = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ParkingLotId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PeakHours = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MonthlyReportId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MonthlyReportDatas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MonthlyReportDatas_MonthlyReports_MonthlyReportId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MonthlyReportDatas_MonthlyReportId",
                table: "MonthlyReportDatas",
            ...
            BEGIN
                ...
                SET Score = (
                    SELECT AVG(Score)
                    FROM Reviews
                    WHERE ParkingLotId = NEW.ParkingLotId
                )
                WHERE Id = NEW.ParkingLotId;
            END;
        ");
            ...
            FOR EACH ROW
            BEGIN
                IF OLD.ParkingLotId != NEW.ParkingLotId THEN
                    UPDATE ParkingLots
                    SET Score = (
